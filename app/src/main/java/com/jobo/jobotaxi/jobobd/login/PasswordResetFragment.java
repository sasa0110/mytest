...
public class PasswordResetFragment extends Fragment {
    ...
    private AppCompatButton btnLoginWithNewPassword;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnLoginWithNewPassword = view.findViewById(R.id.btnResetPassword);
        btnLoginWithNewPassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.passwordResetToLogin();
            }
        });
